        ...
        <div className="rounded-2xl border border-white/[0.08] bg-[#0c0c12] p-8 text-center space-y-4">
          ...
          <div>
            ...
            <p className="mt-1.5 text-xs text-zinc-400 max-w-lg mx-auto leading-relaxed">
              Ketik pertanyaan operasional apa pun atau klik salah satu intent di atas untuk memulai penelusuran live-event terstruktur dari 160+ event dan 1.800+ entitas terverifikasi.
            </p>
          </div>
        </div>
      )}
