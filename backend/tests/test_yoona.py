"""Test suite untuk AI Copilot Yoona — endpoints, intelligence, budget, sound calculations, dan gate security."""
import os
import httpx
import pytest
...
def test_yoona_event_graph_analysis():
    """Menguji pemahaman Yoona tentang Event Graph dan dependensi blocker."""
    payload = {
...
def test_yoona_gate_scanner_and_crowd_safety():
